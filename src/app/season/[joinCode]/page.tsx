      ...
      <div className="w-full lg:w-[320px] xl:w-[380px] flex flex-col h-full shrink-0">
         ...
         <div className="bg-white rounded-[20px] shadow-sm border border-gray-100 flex-1 flex flex-col p-4">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
               {/* Player Item */}
               <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0 group cursor-pointer">
                  <div className="relative">
                     <div className="w-10 h-10 rounded-full bg-[#39b4ad] flex items-center justify-center overflow-hidden">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Ales" alt="avatar" className="w-full h-full object-cover" />
                     </div>
                     <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#efc463] rounded-full border border-white flex items-center justify-center shadow-sm">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                     <div className="flex items-center gap-2">
                        <h4 className="text-[14px] font-bold text-gray-800 truncate leading-tight">Ales Turk</h4>
                        <span className="bg-[#efc463] text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider leading-none">Super Admin</span>
                     </div>
                     <p className="text-[12px] text-gray-400 font-medium truncate mt-0.5">alesturk89@gmail.com</p>
                  </div>
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#fdf8ed] text-[#efc463] group-hover:bg-[#f6e5b6] transition-colors cursor-pointer shrink-0">
               ...
               <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0 group cursor-pointer">
                  <div className="relative">
                     <div className="w-10 h-10 rounded-full bg-[#39b4ad] flex items-center justify-center overflow-hidden">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Aljosa" alt="avatar" className="w-full h-full object-cover" />
                     </div>
                     <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#efc463] rounded-full border border-white flex items-center justify-center shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 text-white">
                          <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                     <div className="flex items-center gap-2">
                        <h4 className="text-[14px] font-bold text-gray-800 truncate leading-tight">Aljosa Veit</h4>
                        <span className="bg-[#efc463] text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider leading-none">Super Admin</span>
                     </div>
                     <p className="text-[12px] text-gray-400 font-medium truncate mt-0.5">aljosa.veit@gmail.com</p>
                  </div>
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#fdf8ed] text-[#efc463] group-hover:bg-[#f6e5b6] transition-colors cursor-pointer shrink-0">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                       <path d="M3 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM8.5 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM15.5 8.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
               ...
               <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0 group cursor-pointer">
                  <div className="relative">
                     <div className="w-10 h-10 rounded-full bg-[#39b4ad] flex items-center justify-center overflow-hidden">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Hinko" alt="avatar" className="w-full h-full object-cover" />
                     </div>
                     <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#efc463] rounded-full border border-white flex items-center justify-center shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 text-white">
                          <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                     <div className="flex items-center gap-2">
                        <h4 className="text-[14px] font-bold text-gray-800 truncate leading-tight">Hinko Pajser</h4>
                        <span className="bg-[#efc463] text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider leading-none">Super Admin</span>
                     </div>
                     <p className="text-[12px] text-gray-400 font-medium truncate mt-0.5">luka.cepe@gmail.com</p>
                  </div>
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#fdf8ed] text-[#efc463] group-hover:bg-[#f6e5b6] transition-colors cursor-pointer shrink-0">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                       <path d="M3 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM8.5 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM15.5 8.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
               ...
               <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0 group cursor-pointer">
                  <div className="relative">
                     <div className="w-10 h-10 rounded-full bg-[#39b4ad] flex items-center justify-center overflow-hidden">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Jernej" alt="avatar" className="w-full h-full object-cover" />
                     </div>
                     <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#efc463] rounded-full border border-white flex items-center justify-center shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 text-white">
                          <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                     <div className="flex items-center gap-2">
                        <h4 className="text-[14px] font-bold text-gray-800 truncate leading-tight">Jernej Volf</h4>
                        <span className="bg-[#efc463] text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider leading-none">Super Admin</span>
                     </div>
                     <p className="text-[12px] text-gray-400 font-medium truncate mt-0.5">jernej27@gmail.com</p>
                  </div>
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#fdf8ed] text-[#efc463] group-hover:bg-[#f6e5b6] transition-colors cursor-pointer shrink-0">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                       <path d="M3 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM8.5 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM15.5 8.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
               ...
               <div className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0 group cursor-pointer">
                  <div className="relative">
                     <div className="w-10 h-10 rounded-full bg-[#39b4ad] flex items-center justify-center overflow-hidden">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Matej" alt="avatar" className="w-full h-full object-cover" />
                     </div>
                     <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#efc463] rounded-full border border-white flex items-center justify-center shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 text-white">
                          <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                     <div className="flex items-center gap-2">
                        <h4 className="text-[14px] font-bold text-gray-800 truncate leading-tight">Matej Tomazic</h4>
                        <span className="bg-[#efc463] text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider leading-none">Super Admin</span>
                     </div>
                     <p className="text-[12px] text-gray-400 font-medium truncate mt-0.5">matejtomazic05@gmail.com</p>
                  </div>
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#fdf8ed] text-[#efc463] group-hover:bg-[#f6e5b6] transition-colors cursor-pointer shrink-0">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                       <path d="M3 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM8.5 10a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM15.5 8.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
