...
export default function Home() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="flex flex-col h-[100dvh] bg-[#F4F6F8] items-center justify-center p-6">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-lg max-w-sm w-full space-y-8 border border-gray-100/50 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex flex-col items-center space-y-3">
             <img 
              src="https://www.sport2go.app/image/logo.svg" 
              alt="SPORT2GO Logo" 
              className="h-16 w-auto drop-shadow-sm mb-2"
            />
          ...
          <button
            ...
            className="w-full bg-[#5BA582] hover:bg-[#4d8c6f] text-white font-bold text-[15px] py-4 px-6 rounded-2xl shadow-[0_4px_14px_rgba(91,165,130,0.3)] transition-all flex items-center justify-center space-x-3 active:scale-[0.98]"
          >
