        ...
        <div className="flex-1 ui-card p-6 md:p-10 flex flex-col">
          <div className="flex items-center space-x-3 mb-8">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-[#dba032]">
                <path fillRule="evenodd" d="M3 6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6Zm14.25 6a.75.75 0 0 1-.75.75h-5.69l1.72 1.72a.75.75 0 1 1-1.06 1.06l-3-3a.75.75 0 0 1 0-1.06l3-3a.75.75 0 1 1 1.06 1.06l-1.72 1.72H16.5a.75.75 0 0 1 .75.75Z" clipRule="evenodd" />
             </svg>
          ...
          <form onSubmit={handleSubmit} className="ui-form-box space-y-6 flex-1 flex flex-col">
             ...
             <div className="mt-8 pt-6 border-t border-gray-100">
                <div className="flex items-center justify-center mb-4">
                   <h3 className="ui-label block m-0 text-center">Dodajanje igralcev</h3>
                ...
                <div className="bg-[#f8fbfa] border border-[#d2e8df] rounded-xl p-6 text-center shadow-inner">
                   <div className="w-12 h-12 bg-[#6db592]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 text-[#3b879c]">
                       <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
                     </svg>
                   </div>
                   <h4 className="text-[#3b879c] font-bold text-[15px] mb-1">Povezava bo generirana po shranitvi</h4>
                   <p className="text-gray-500 text-sm max-w-sm mx-auto">
                     Ko boste shranili novo ekipo, boste preusmerjeni na nadzorno ploščo, kjer boste lahko enostavno poslali povezavo za pridružitev vsem igralcem.
                   </p>
                </div>
             </div>
