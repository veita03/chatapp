               ...
               {filteredTeams && filteredTeams.length === 0 ? (
                 ...
                 filteredTeams?.map((team, idx) => (
                   <div key={team._id} className="flex flex-col sm:flex-row sm:items-center bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-[#eeb054]/50 transition-colors shadow-sm group">
                     ...
                     <div className="px-4 pb-4 pt-1 sm:pt-0 sm:pb-0 sm:py-5 flex flex-wrap gap-2 items-center sm:border-l border-gray-100 bg-gray-50/50 sm:bg-transparent rounded-b-xl sm:rounded-none">
                        <button 
                          onClick={() => router.push(`/chat/${team._id}`)}
                          className="px-3 py-2 border border-[#5BA582]/30 text-[#5BA582] font-bold text-sm bg-white rounded-lg hover:bg-[#5BA582]/10 transition-colors flex items-center space-x-1.5 whitespace-nowrap"
                        >
                        ...
                        <button className="px-3 py-2 border border-[#f3ebcd] text-[#dba032] font-bold text-sm bg-white rounded-lg hover:bg-[#fdfaf1] transition-colors whitespace-nowrap">
                          {t.viewSeasons}
                        </button>
                        <button 
